...
public class HomePage extends BasePage{
	...
	@FindBy(xpath="//ul[@class='nav navbar-nav']/child::li//a[@href='/login']")WebElement link_signUpLogin;
	@FindBy(xpath="//*[text()=' Logout']")WebElement logout;
	@FindBy(xpath="//*[text()=' Products']")WebElement products;
	@FindBy(xpath="//*[text()=' Cart']")WebElement carts;
	@FindBy(xpath="//*[text()=' Contact us']")WebElement ContactUs;
	@FindBy(xpath="//*[text()=' Test Cases']")WebElement TestCases;
